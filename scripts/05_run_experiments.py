...
from record.provenance import git_revision as _git_revision
...
def git_revision() -> str:
    """Revision recorded in the .meta.json sidecar (see record.provenance)."""
    return _git_revision(Path(__file__).resolve().parents[1])
